...
exports.PRESET_AVATARS = void 0;
exports.isPresetAvatarId = isPresetAvatarId;
exports.getPresetAvatar = getPresetAvatar;
exports.PRESET_AVATARS = [
    {
...
function isPresetAvatarId(value) {
    return exports.PRESET_AVATARS.some((avatar) => avatar.id === value);
}
function getPresetAvatar(id) {
    return exports.PRESET_AVATARS.find((avatar) => avatar.id === id);
}
//# sourceMappingURL=preset-avatars.js.map